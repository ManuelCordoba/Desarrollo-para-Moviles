...
public class Menu extends AppCompatActivity {
    ...
    Button btnSalir,btnRes,btnMiRes,btnAdmin,btnHistRes,btnAdminRes;
    JSONArray ja = null;
    String[] elementos;
    String IP = "10.0.2.2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMiRes= findViewById(R.id.btnMisRes);
        btnSalir= findViewById(R.id.btnSal);
        btnAdmin= findViewById(R.id.btnAdmin);
        btnAdmin= findViewById(R.id.btnAdmin);
        btnAdminRes= findViewById(R.id.btnAdminRes);
        btnHistRes= findViewById(R.id.btnHistRes);
        btnSalir= findViewById(R.id.btnSal);
        btnRes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                servicio= new Intent(Menu.this,Imagenes.class);
                servicio.putExtra("idU",id);
                System.out.println(id);
                startActivity(servicio);
            }
        });
        btnMiRes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                servicio= new Intent(Menu.this,ReservasActivas.class);
                servicio.putExtra("idU",id);
                System.out.println(id);
                startActivity(servicio);
            }
        });
        btnAdminRes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                servicio= new Intent(Menu.this,Lista_consulta.class);
                startActivity(servicio);
            }
        });
                ...
                if(ja.length()!=0) {
                    for (int i = 0; i < ja.length(); i++) {
                        ...
                        if(obj.getString("id_permiso").equals("2")){
                            ...
                            btnMiRes.setVisibility(View.VISIBLE);}
                        if(obj.getString("id_permiso").equals("3")){

                            btnAdminRes.setVisibility(View.VISIBLE);
                            btnAdmin.setVisibility(View.VISIBLE); }
                        if(obj.getString("id_permiso").equals("5")){

                            btnHistRes.setVisibility(View.VISIBLE);}
