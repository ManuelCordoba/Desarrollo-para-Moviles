...
public class ReservasActivas extends AppCompatActivity {
    ListView lista,listaR;
    String[] elementos,elementosR;
    JSONArray ja = null;
    String docu,id, miurl="";
    String IP = "10.0.2.2";
    Button btnRegUsu;
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent= getIntent();
        id=intent.getStringExtra("idU");
        init2();

    }
    public void init2(){
        int c=2;
        miurl="http://"+IP+"/"+sitio+"/"+"consultar_reservas_act.php?id="+id;
        new ReservasActivas.ConsultarDatos().execute(miurl);
    }
    public void mostrar() {
        ArrayAdapter<String> adapter1 = new ArrayAdapter(ReservasActivas.this,android.R.layout.simple_list_item_1, elementos);
            ...
            try {
                ...
                if(ja.length()!=0) {
                    for (int i = 0; i < ja.length(); i++) {
                        ...
                        variable2 = obj.getString("id_ser");
                        variable3 = obj.getString("id_usu");
                        variable4 = obj.getString("date");
                        variable5 = obj.getString("time");

                        System.out.println(variable1);

                        elementos[i] = "ID reserva : "+variable1+"      ID servicio : "+ variable2+"    Fecha : "+ variable4+" \nHora : "+variable5;
