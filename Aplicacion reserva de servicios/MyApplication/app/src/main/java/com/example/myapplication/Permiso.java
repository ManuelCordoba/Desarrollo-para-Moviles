...
public class Permiso extends AppCompatActivity {
    ...
    public void init2(){
        int c=2;
        miurl="http://"+IP+"/"+sitio+"/"+"consultar_permisos.php?";
        new Permiso.ConsultarDatos().execute(miurl);
    }
    public void mostrar() {
        ArrayAdapter<String> adapter1 = new ArrayAdapter(Permiso.this,android.R.layout.simple_list_item_1, elementos);
            ...
            try {
                ...
                if(ja.length()!=0) {
                    for (int i = 0; i < ja.length(); i++) {
                        ...
                        variable1 = obj.getString("nom_permiso");
                        variable2 = obj.getString("id_permiso");

                        elementos[i] = "Permiso : "+variable1+" \nid_permiso :"+ variable2;
